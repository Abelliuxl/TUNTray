...
var Translations = LanguageMap{
	Chinese: {
		...
		"stop_tooltip":    "停止 TUN",
		"system_proxy_tooltip": "开启或关闭系统代理",
		...
		// Dialog messages
		"add_proxy_protocol_title":  "选择协议",
		"add_proxy_protocol_prompt": "请选择代理协议:",
		"add_proxy_address_title":   "代理地址",
		"add_proxy_address_prompt":  "请输入代理服务器地址:",
		"add_proxy_port_title":      "代理端口",
		"add_proxy_port_prompt":     "请输入代理服务器端口:",
		"proxy_address_empty_error": "代理地址不能为空。",
		"proxy_port_empty_error":    "代理端口不能为空。",
	...
	English: {
		...
		"system_proxy_tooltip": "Toggle system proxy on/off",
		...
		// Dialog messages
		"add_proxy_protocol_title":  "Select Protocol",
		"add_proxy_protocol_prompt": "Select proxy protocol:",
		"add_proxy_address_title":   "Proxy Address",
		"add_proxy_address_prompt":  "Enter proxy server address:",
		"add_proxy_port_title":      "Proxy Port",
		"add_proxy_port_prompt":     "Enter proxy server port:",
		"proxy_address_empty_error": "Proxy address cannot be empty.",
		"proxy_port_empty_error":    "Proxy port cannot be empty.",
